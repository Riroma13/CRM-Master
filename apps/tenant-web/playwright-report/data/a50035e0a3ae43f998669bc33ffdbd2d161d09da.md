...
- Name: 05-booking-calendario.spec.ts >> Booking & Calendario >> admin calendario shows KPIs and config
- Location: e2e/05-booking-calendario.spec.ts:6:7
...
Locator: getByText('Configuración')
Expected: visible
Error: strict mode violation: getByText('Configuración') resolved to 2 elements:
    1) <h2 class="text-[16px] font-semibold text-[#1B1B1D]">Configuración</h2> aka getByRole('heading', { name: 'Configuración' })
    2) <p class="text-[13px] text-[#45464D]">Cargando configuración...</p> aka getByText('Cargando configuración...')

Call log:
  - Expect "toBeVisible" with timeout 10000ms
  - waiting for getByText('Configuración')
